...
<div class="modal" id="vtaModal">
    <div class="modal-content">
        <h4>CRUD Sucursales</h4>
        <br>
        <form id="frm-suc" method="POST">
            <div class="row">
            ...
            <div class="row">
              <div class="input-field col s12">
                   <input type="text" id="noms" name="noms" class="validate" >
                   <label class="active" for="noms">Nombre de la sucursal:</label>
              </div>
            ...
            <div class="row">
              <div class="input-fiels col s12">
                <select name="idreg" id="idreg" class="validate">
                  <?php
                    include_once("llenaSelect.php");
                  ?>
                </select>
                <label class="active" for="idreg">Region:</label>
              </div>
            </div>
        </form>
    </div>
