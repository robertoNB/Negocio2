...
<div class="modal" id="vtaModal">
    <div class="modal-content">
        ...
        <form id="frm-prod" method="POST">
            ...
            <div class="row">
              <div class="input-field col s12">
                   <input type="text" id="nomp" name="nomp" class="validate" >
                   <label class="active" for="nomp">Nombre del producto:</label>
              </div>
            </div>
            <div class="row">
              <div class="input-field col s12">
                <input type="text" id="um" name="um" class="validate">
                <label class="active" for="um">Unidad de Medida</label>
              </div>
            </div>
            <div class="row">
              <div class="input-fiels col s12">
              <label class="active" for="iddep">Departamento:</label>
                <select name="iddep" id="iddep" class="validate">
                  <?php
