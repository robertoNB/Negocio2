...
<div class="modal" id="vtaModal">
    <div class="modal-content">
        <h4>CRUD Departamento</h4>
        <br>
        <form id="frm-depto" method="POST">
            <div class="row">
            ...
            <div class="row">
              <div class="input-field col s12">
                   <input type="text" id="nomd" name="nomd" class="validate" >
                   <label class="active" for="nomd">Nombre del Depto:</label>
              </div>
            </div>
        </form>
    </div>
